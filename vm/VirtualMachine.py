...
class VirtualMachine:
    ...
    def bigswitch(self):
        ...
        while self.running:
            ...
            elif instruction[0] == 35:  # NOT
                if not Register.reg_dict[reg1]:
                    Register.reg_dict[reg1] = 1
                else:
                    Register.reg_dict[reg1] = 0

            elif instruction[0] == 36:  # ALLC
                # this is for putting on heap
                # the SL that's the top of stack, where heap start
                Register.reg_dict[reg1] = self.heap_point
    ...
    def makeStack(self, mmap_bin_file, sym_dict):
        ...
        Register.reg_dict["FP"] = Register.reg_dict["SP"]
        self.heap_point = Register.reg_dict["SL"]
